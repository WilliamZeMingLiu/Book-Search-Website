...
<body>
	...
	<h1 id="results_for"style="font-size:30px; float: left; margin-left: 15%;">Results for "</h1>
	<!-- Book Table -->
	...
	<script>
		...
		document.getElementById("results_for").innerText += sessionStorage.getItem("user_input");
		...
		for(i=0; i < data.length; i++){
			...
			for(j=0; j < 2; j++){
				...
				if(j==0){
					...
					img.setAttribute('name', data[i]['id']);

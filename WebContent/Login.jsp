...
<body>
	...
	<div class="user_field">
		<% if(session.getAttribute("user_error") == "wrong_password"){%>
		<p style="color: red;">Incorrect password</p>
		<%}%><br/>
		<% if(session.getAttribute("user_error") == "user_exist"){%>
		<p style="color: red;">Username does not exist</p>
		<%}%><br/>
		<form class="user_form" onsubmit="return validate_user()" method="GET" action="A3_Servlet_Login">
			...
			<input name="password" id="password" type="password" style="width: 100%; height: 20px; font-size: 15px; padding: 5px; margin-bottom: 40px;">
			<input name="submit" class="user_button" type="submit" value="Sign In"/>
		</form>
	</div>
	<!--  /User Form -->
